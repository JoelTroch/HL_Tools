...
std::string GetSharedCredits()
{
	return std::string( 
		...
		u8"( \"Id Technology\" ). Id Technology \xc2\xa9 1996 Id Software, Inc.\n"
		u8"All Rights Reserved.\n\n"
		u8"Copyright \xc2\xa9 1998-2002, Valve LLC.\n"
		u8"All rights reserved.\n\n"
		...
		u8"Copyright \xc2\xa9 2008 - 2016, Nigel Stewart <nigels[]users sourceforge net>\n"
		u8"Copyright \xc2\xa9 2002 - 2008, Milan Ikits <milan ikits[]ieee org>\n"
		u8"Copyright \xc2\xa9 2002 - 2008, Marcelo E.Magallon <mmagallo[]debian org>\n"
		u8"Copyright \xc2\xa9 2002, Lev Povalahev\n"
		u8"All rights reserved.\n\n"
		u8"Contains The OpenGL Mathemathics library (GLM)\n"
		u8"Copyright \xc2\xa9 2005 - 2016 G-Truc Creation\n\n"
